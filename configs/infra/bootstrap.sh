...
dotenv run -- terraform apply -auto-approve -var="env=$ENV" -var="snowflake_aws_iam_user_arn=$SNOWFLAKE_IAM_USER_ARN" -var="snowflake_external_id=$SNOWFLAKE_EXTERNAL_ID"
